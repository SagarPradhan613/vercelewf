    ...
    return (
        <>
            ...
            <div className="w-full overflow-hidden lg:py-28  lg:pb-44 px-4 lg:px-0 py-10 pb-28 relative hero-section ">
                ...
                <div className='flex slowly-visible-icons gap-10 w-full lg:bottom-10 bottom-5 right-[10%] absolute justify-end'>
            ...
            <div ref={viewRef} className="w-full  overflow-hidden relative flex flex-col justify-center ">
                ...
                <div className="relative lg:px-48 lg:py-24 px-6 py-6 h-full w-full z-20">
                    ...
                    <div className="lg:mt-20  test-scroll mt-10 lg:items-end w-full justify-center items-center lg:flex-row flex-col flex gap-6">
                        ...
                        <div className="transform group hideDelay  hover:scale-90 transition-transform duration-500">
                            ...
                            <div className=" flex flex-col justify-between h-full px-8 min-h-[481px] min-w-[350px] lg:min-w-[400px] py-8 bg-[#0040A1]">
                                ...
                                <div className="w-full items-center -mt-10 flex justify-between">
                                    ...
                                    <div className="flex  transform group-hover:scale-110 transition-transform duration-500 items-center lg:px-6 px-4 py-2 lg:py-3 text-white bg-[#F6161E]">
                        ...
                        <div className="transform group hideRightAnimation hover:scale-90 transition-transform duration-500 flex flex-col justify-between h-full px-8 min-h-[481px] min-w-[350px] lg:min-w-[400px] py-8 bg-[#012F6D]">
                            <div className="w-full flex-col flex">
            ...
            {/* forth box */}
            <div className="bg-[#E8ECF2] overflow-hidden  w-full px-4 py-6 lg:px-28 lg:py-28">
            ...
            <div className="flex flex-col lg:flex-row justify-between lg:px-28 px-10 py-6 lg:py-10 bg-white w-full">
                ...
                <div className="flex gap-8">
                    <div className="transform hover:scale-125 transition-transform duration-500">
