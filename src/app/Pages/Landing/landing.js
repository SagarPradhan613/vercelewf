...
const Landing = () => {
    ...
    return (
        <>
            {/* first box */}
            <div className="w-full lg:py-28 hideAnimation lg:pb-44 px-4 lg:px-0 py-10 pb-28 relative hero-section ">
                <div className='flex flex-col lg:flex-row'>
                    <div className="w-full lg:pl-28  lg:w-1/2">
                        <div>
                            <img src='/Images/herofulltext.png'></img>
                        </div>
                        <div className='mt-10'>
                            <p className='tiro-regular font-normal text-6xl text-[#012F6D]'>Guiding your <br></br> crypto investments to unforeseen heights</p>
                        </div>
                    </div>
                ...
                <div className='flex gap-10 w-full lg:bottom-10 bottom-5 right-[10%] absolute justify-end'>
            ...
            <div className='w-full mt-10 lg:mt-0 hideAnimation  lg:px-0 lg:pt-64 lg:pb-36 lg:pl-28 pt-32 pb-16  flex flex-col lg:flex-row relative bg-[#012F6D]  second-section'>
                        ...
                        <div>
                            ...
                            <div className='flex w-full  justify-between mt-2'>
                                ...
                                <div className='flex text-white'>
                                    <p className='font-bold lg:text-7xl text-3xl'>14.04</p>
                                    <p className='font-bold lg:text-7xl text-3xl ml-6'>M</p>
                ...
                <div className="lg:w-1/2 w-full mt-8 lg:mt-0 lg:pl-28">
                    ...
                    <div ref={boxRef} className="carousel-container mt-10 scroll-smooth w-full relative overflow-hidden flex h-full">
                        <div className="carousel-card flex flex-col justify-between px-10 py-10 h-[85%] mx-3 min-w-[300px] bg-white">
                            <div>
            ...
            {/* third box */}
            <div ref={viewRef} className="w-full hideAnimation overflow-hidden relative flex flex-col justify-center ">
                ...
                <div className="relative lg:px-48 lg:py-24 px-6 py-6 h-full w-full z-20">
                    ...
                    <div className="lg:mt-20 test-scroll mt-10 lg:items-end w-full justify-center items-center lg:flex-row flex-col flex gap-6">
                        <div className="transform hover:scale-90 transition-transform duration-500 flex flex-col justify-between h-full px-8 min-h-[481px] min-w-[350px] lg:min-w-[400px] py-8 bg-[#012F6D]">
                        ...
                        <div className="transform scaleAnimation hover:scale-90 transition-transform duration-500">
                            ...
                            <div className=" flex flex-col justify-between h-full px-8 min-h-[481px] min-w-[350px] lg:min-w-[400px] py-8 bg-[#0040A1]">
                                <div className="w-full flex-col flex">
            ...
            <div  className="bg-[#E8ECF2]  w-full px-4 py-6 lg:px-28 lg:py-28">
                <div  className="flex hideAnimation lg:flex-row flex-col w-full gap-4">
                    ...
                    <div className=" lg:w-1/3 lg:min-h-[547px] relative bg-[#F6161E]">
                        <div className="relative flex-col h-full flex py-10 px-8 justify-between z-20">
                            <div className="text-5xl text-white">
                                <div className="flex items-center">
                                    <p className="tiro-regular">Expert</p>
                    ...
                    <div className=" lg:w-1/3 flex flex-col gap-4 lg:min-h-[547px] ">
                        <div className=" forth-last-top h-1/2 w-full flex-col  flex py-10 px-8 justify-between z-20">
                        ...
                        <div className=" forth-last-bottom h-1/2 w-full flex-col  flex py-10 px-8 justify-between z-20">
                            <div className="text-4xl text-white">
                                <div className="flex items-center">
                ...
                <div  className="lg:mt-20 hideAnimation lg:max-h-[605px] mt-10 lg:flex-row flex-col flex w-full">
                    ...
                    <div className="lg:w-1/2 relative w-full">
                        ...
                        <img src="/Images/croppedsixthsecbg.png" className="h-full w-full"></img>
                    </div>
                </div>
            </div>
            ...
            <div ref={viewRef} className="flex hideAnimation lg:flex-row flex-col">
                <div className="lg:w-1/2 lg:py-24 w-full lg:-mt-8 px-10 py-10 lg:px-28 bg-[#012F6D]">
                    ...
                    <div className="form mt-16">
                        ...
                        <div className="w-full mt-1 flex">
                            <input placeholder="Email" className="white px-4 w-[80%] py-4 text-white font-bold text-base bg-[#012F6D] border-b border-white"></input>
                            <div className="flex  items-center justify-between w-[20%] border-b border-t-0  border-white">
                                <p className="font-bold text-base text-white">Verify</p>
                                <div>
                                    <svg width="19" height="12" viewBox="0 0 19 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="w-full flex">
                            <input placeholder="Mobile" className="px-4 w-[80%] white py-4 text-white font-bold text-base bg-[#012F6D] border-b border-white"></input>
                            <div className="flex items-center justify-between w-[20%] border-b border-white">
                                <p className="font-bold text-base text-white">Verify</p>
                                <div>
                                    <svg width="19" height="12" viewBox="0 0 19 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.8788 6.35064C18.1717 6.05775 18.1717 5.58288 17.8788 5.28998L13.1058 0.517013C12.813 0.224119 12.3381 0.224119 12.0452 0.517013C11.7523 0.809906 11.7523 1.28478 12.0452 1.57767L16.2878 5.82031L12.0452 10.063C11.7523 10.3558 11.7523 10.8307 12.0452 11.1236C12.3381 11.4165 12.813 11.4165 13.1058 11.1236L17.8788 6.35064ZM0.4375 6.57031L17.3485 6.57031L17.3485 5.07031L0.4375 5.07031L0.4375 6.57031Z" fill="white" />
                ...
                <div className="lg:w-1/2 lg:py-24 w-full  px-10 py-10 lg:px-28 bg-white">
                    ...
                    <div className="form mt-16">
                        ...
                        <div className="flex mt-4 w-[50%] transform hover:scale-110 transition-transform duration-500 lg:w-1/3 items-center justify-between px-3 lg:px-6 py-3 gap-2 bg-[#0040A1]">
                            <p className="lg:text-base text-sm font-bold text-white ">Submit</p>
                            <div className="flex items-center h-full ">
                                <svg width="19" height="12" viewBox="0 0 19 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M18.2812 6.26764C18.5741 5.97474 18.5741 5.49987 18.2812 5.20698L13.5082 0.434005C13.2153 0.141112 12.7404 0.141111 12.4475 0.434005C12.1546 0.726898 12.1546 1.20177 12.4475 1.49467L16.6902 5.73731L12.4475 9.97995C12.1546 10.2728 12.1546 10.7477 12.4475 11.0406C12.7404 11.3335 13.2153 11.3335 13.5082 11.0406L18.2812 6.26764ZM0.839844 6.4873L17.7508 6.48731L17.7508 4.98731L0.839844 4.9873L0.839844 6.4873Z" fill="white" />
                                </svg>
